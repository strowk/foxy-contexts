...
func stop(process *os.Process) error {
	...
	// https://github.com/iwdgo/sigintwindows/blob/5b9fdf930454cd8036eb5c8997763d9fe61d637d/signal_windows.go#L14-L26
	...
	//nolint:gosec // #nosec G204 -- the PID is given to us by the system, so it should be safe to use
